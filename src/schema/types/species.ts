...
const SpeciesType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    eyeColors: {
      ...
      resolve: species => {
        return species.eye_colors.split(',').map((s: string) => s.trim());
      },
...
have eyes.`,
    ...
    hairColors: {
      ...
      resolve: species => {
        ...
        return species.hair_colors.split(',').map((s: string) => s.trim());
      },
...
have hair.`,
    ...
    skinColors: {
      type: new GraphQLList(GraphQLString),
      resolve: species => {
        return species.skin_colors.split(',').map((s: string) => s.trim());
      },
